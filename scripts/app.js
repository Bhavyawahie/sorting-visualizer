...
const start = async () => {
    ...
    if(speedValue === 0) {
        alert('Please Select a Speed from the Dropdown!')
        return ;
    }
    if(algoValue === 0) {
...
// Add class "responsive" to the navbar div to convert it to hamburger styled one (using css media query)
...
document.querySelector(".icon").addEventListener("click", response)             // Hamburger Navbar
